...
namespace LenovoLegionToolkit.WPF.Resources {
    ...
    public class Resource {
        ...
        /// <summary>
        ///   查找类似 Keyboard backlight cannot be controlled in here when Vantage or it&apos;s services are running. 的本地化字符串。
        /// </summary>
        ...
        /// <summary>
        ///   查找类似 Currently, only Huawei tablet screen scaling is set, and it will be configured separately according to screen rules. 的本地化字符串。
        /// </summary>
